...
export type StorageHash =
  StorageHashBase<'372f0ce39f478856924230680ada8fba31525d132cf49bbcac8017924d3afccb'>;
...
export type FieldOutputTypes = {
  readonly __unbound__: {
    readonly QuotedRow: {
      ...
      readonly value: CodecTypes['sqlite/text@1']['output'] | null;
    };
  };
};
export type FieldInputTypes = {
  readonly __unbound__: {
    readonly QuotedRow: {
      ...
      readonly value: CodecTypes['sqlite/text@1']['input'] | null;
    };
  };
};
export type StorageColumnTypes = {
  readonly __unbound__: {
    readonly 'quoted"table': {
      readonly id: CodecTypes['sqlite/integer@1']['output'];
      readonly value: CodecTypes['sqlite/text@1']['output'] | null;
    };
  };
