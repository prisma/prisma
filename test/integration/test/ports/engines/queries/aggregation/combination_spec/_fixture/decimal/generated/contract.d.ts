...
export type StorageHash =
  StorageHashBase<'6df294e80c2bf81a495f8523bdb805f90682c00df21e27b5353cdb425219505c'>;
...
export type StorageColumnTypes = {
  readonly public: {
    readonly item: {
      readonly db_dec: CodecTypes['pg/numeric@1']['output'];
      readonly id: CodecTypes['pg/text@1']['output'];
    };
  };
};
export type StorageColumnInputTypes = {
  readonly public: {
    readonly item: {
      readonly db_dec: CodecTypes['pg/numeric@1']['input'];
      readonly id: CodecTypes['pg/text@1']['input'];
    };
  };
};
          ...
          readonly Item: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly dec: { readonly column: 'db_dec' };
              };
            };
          };
        };
