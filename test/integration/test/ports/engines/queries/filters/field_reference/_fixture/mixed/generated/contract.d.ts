...
export type FieldOutputTypes = {
  readonly public: {
    readonly TestModel: {
      ...
      readonly int2: ReadonlyArray<CodecTypes['pg/int4@1']['output']>;
      readonly bInt: CodecTypes['pg/int8@1']['output'] | null;
      readonly bInt2: ReadonlyArray<CodecTypes['pg/int8@1']['output']>;
      readonly float: CodecTypes['pg/float8@1']['output'] | null;
      readonly float2: ReadonlyArray<CodecTypes['pg/float8@1']['output']>;
      readonly bytes: CodecTypes['pg/bytea@1']['output'] | null;
      readonly bytes2: ReadonlyArray<CodecTypes['pg/bytea@1']['output']>;
      readonly bool: CodecTypes['pg/bool@1']['output'] | null;
      readonly bool2: ReadonlyArray<CodecTypes['pg/bool@1']['output']>;
      readonly dt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
      readonly dt2: ReadonlyArray<CodecTypes['pg/timestamptz-temporal@1']['output']>;
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly TestModel: {
      ...
      readonly int2: ReadonlyArray<CodecTypes['pg/int4@1']['input']>;
      readonly bInt: CodecTypes['pg/int8@1']['input'] | null;
      readonly bInt2: ReadonlyArray<CodecTypes['pg/int8@1']['input']>;
      readonly float: CodecTypes['pg/float8@1']['input'] | null;
      readonly float2: ReadonlyArray<CodecTypes['pg/float8@1']['input']>;
      readonly bytes: CodecTypes['pg/bytea@1']['input'] | null;
      readonly bytes2: ReadonlyArray<CodecTypes['pg/bytea@1']['input']>;
      readonly bool: CodecTypes['pg/bool@1']['input'] | null;
      readonly bool2: ReadonlyArray<CodecTypes['pg/bool@1']['input']>;
      readonly dt: CodecTypes['pg/timestamptz-temporal@1']['input'] | null;
      readonly dt2: ReadonlyArray<CodecTypes['pg/timestamptz-temporal@1']['input']>;
    };
  };
};
...
export namespace Models {
  export type public_TestModel = {
    ...
    string2: ReadonlyArray<CodecTypes['pg/text@1']['output']>;
    int: CodecTypes['pg/int4@1']['output'] | null;
    int2: ReadonlyArray<CodecTypes['pg/int4@1']['output']>;
    bInt: CodecTypes['pg/int8@1']['output'] | null;
    bInt2: ReadonlyArray<CodecTypes['pg/int8@1']['output']>;
    float: CodecTypes['pg/float8@1']['output'] | null;
    float2: ReadonlyArray<CodecTypes['pg/float8@1']['output']>;
    bytes: CodecTypes['pg/bytea@1']['output'] | null;
    bytes2: ReadonlyArray<CodecTypes['pg/bytea@1']['output']>;
    bool: CodecTypes['pg/bool@1']['output'] | null;
    bool2: ReadonlyArray<CodecTypes['pg/bool@1']['output']>;
    dt: CodecTypes['pg/timestamptz-temporal@1']['output'] | null;
    dt2: ReadonlyArray<CodecTypes['pg/timestamptz-temporal@1']['output']>;
