...
export type FieldOutputTypes = {
  readonly public: {
    readonly TestModel: {
      ...
      readonly json_list: ReadonlyArray<CodecTypes['pg/jsonb@1']['output']>;
      readonly json_list2: ReadonlyArray<CodecTypes['pg/jsonb@1']['output']>;
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly TestModel: {
      ...
      readonly json_list: ReadonlyArray<CodecTypes['pg/jsonb@1']['input']>;
      readonly json_list2: ReadonlyArray<CodecTypes['pg/jsonb@1']['input']>;
    };
  };
};
...
export namespace Models {
  export type public_TestModel = {
    ...
    json: CodecTypes['pg/jsonb@1']['output'] | null;
    json_list: ReadonlyArray<CodecTypes['pg/jsonb@1']['output']>;
    json_list2: ReadonlyArray<CodecTypes['pg/jsonb@1']['output']>;
          ...
          readonly TestModel: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly json_list: { readonly column: 'json_list' };
                readonly json_list2: { readonly column: 'json_list2' };
              };
            };
          };
        };
