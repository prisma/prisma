...
export type FieldOutputTypes = {
  readonly public: {
    readonly Post: {
      ...
      readonly userId_2: CodecTypes['pg/int4@1']['output'] | null;
    };
    readonly User: {
      readonly id: CodecTypes['pg/int4@1']['output'];
      readonly name: CodecTypes['pg/text@1']['output'] | null;
      readonly userId: CodecTypes['pg/int4@1']['output'];
      readonly userId2: CodecTypes['pg/int4@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    readonly Post: {
      ...
      readonly userId_2: CodecTypes['pg/int4@1']['input'] | null;
    };
    readonly User: {
      readonly id: CodecTypes['pg/int4@1']['input'];
      readonly name: CodecTypes['pg/text@1']['input'] | null;
      readonly userId: CodecTypes['pg/int4@1']['input'];
      readonly userId2: CodecTypes['pg/int4@1']['input'];
    };
  };
};
        ...
        readonly entries: {
          readonly table: {
            readonly post: {
              ...
              indexes: readonly [
                {
                  readonly name: 'post_userId_userId_2_idx_16bf178c';
                  readonly prefix: 'post_userId_userId_2_idx';
                  readonly columns: readonly ['userId', 'userId_2'];
              ...
              foreignKeys: readonly [
                {
                  ...
                  readonly target: {
                    ...
                    readonly columns: readonly ['userId', 'userId2'];
                  };
                },
              ];
            };
            readonly user: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['userId', 'userId2'] }];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
          };
          ...
          readonly Post: {
            ...
            readonly relations: {
              readonly author: {
                ...
                readonly on: {
                  readonly localFields: readonly ['userId', 'userId_2'];
                  readonly targetFields: readonly ['userId', 'userId2'];
                };
              };
            };
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly userId_2: { readonly column: 'userId_2' };
              };
            };
          };
          readonly User: {
            ...
            readonly relations: {
              readonly posts: {
                ...
                readonly on: {
                  readonly localFields: readonly ['userId', 'userId2'];
                  readonly targetFields: readonly ['userId', 'userId_2'];
                };
              };
            };
            readonly storage: {
...
export namespace Models {
  ...
  export type public_Post = {
    ...
    userId_2: CodecTypes['pg/int4@1']['output'] | null;
