...
export type StorageHash =
  StorageHashBase<'5be577c9af0811e7b5b662297082dacf6e35087bd2dcfbe7e80def4e365755fb'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Subscription: {
      ...
      readonly optedOutAt: CodecTypes['pg/timestamptz@1']['output'] | null;
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Subscription: {
      ...
      readonly optedOutAt: CodecTypes['pg/timestamptz@1']['input'] | null;
    };
  };
};
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly identity: {
              ...
              indexes: readonly [
                {
                  readonly name: 'identity_contactId_idx_ec98db2a';
                  readonly prefix: 'identity_contactId_idx';
            ...
            readonly subscription: {
              ...
              indexes: readonly [
                {
                  readonly name: 'subscription_audienceId_idx_7242acd1';
                  readonly prefix: 'subscription_audienceId_idx';
                  readonly columns: readonly ['audienceId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'subscription_identityId_idx_e29a7785';
                  readonly prefix: 'subscription_identityId_idx';
                  readonly columns: readonly ['identityId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly relations: {
              readonly subscriptions: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['audienceId'];
                };
              };
            };
            readonly storage: {
          ...
          readonly Identity: {
            ...
            readonly relations: {
              ...
              readonly subscriptions: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['identityId'];
                };
              };
            };
            readonly storage: {
