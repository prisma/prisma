...
export type StorageHash =
  StorageHashBase<'336847177af3852776527fb0b8f770d12fc304c8ba6c8e04c861051191c3afd1'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Post: {
      ...
      readonly blog_id: CodecTypes['pg/text@1']['output'];
    };
  };
};
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Post: {
      ...
      readonly blog_id: CodecTypes['pg/text@1']['input'];
    };
  };
};
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly comment: {
              ...
              indexes: readonly [
                {
                  readonly name: 'comment_post_id_idx_865a6df2';
                  readonly prefix: 'comment_post_id_idx';
            ...
            readonly post: {
              ...
              indexes: readonly [
                {
                  readonly name: 'post_blog_id_idx_aa2309ad';
                  readonly prefix: 'post_blog_id_idx';
                  readonly columns: readonly ['blog_id'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly relations: {
              readonly posts: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['blog_id'];
                };
              };
            };
            readonly storage: {
          ...
          readonly Comment: {
            ...
            readonly relations: {
              readonly post: {
                ...
                readonly on: {
                  readonly localFields: readonly ['post_id'];
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly post_id: { readonly column: 'post_id' };
              };
            };
          };
          readonly Post: {
