  ...
  it.fails(
    ...
    () =>
      withPostgresPort<Contract>({ contractJson }, async ({ db }) => {
        ...
        // Prisma 8: array of callbacks for multi-column orderBy.
        ...
        // Prisma 8 (exclusive cursor + skip=1): [{ id: id3, price: 30 }]
        ...
        // Prisma 8 (exclusive cursor + skip=1): [] (past the end)
