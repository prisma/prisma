...
export type StorageHash =
  StorageHashBase<'04585bfe33be0d0cbffff636bc10a5ceaa0031076951546db82ff92ee2fda641'>;
        ...
        readonly entries: {
          readonly table: {
            readonly postOneToMany: {
              ...
              indexes: readonly [
                {
                  readonly name: 'postOneToMany_authorId_idx_e47547ed';
                  readonly prefix: 'postOneToMany_authorId_idx';
            ...
            readonly postOptionalOneToMany: {
              ...
              indexes: readonly [
                {
                  readonly name: 'postOptionalOneToMany_authorId_idx_e47547ed';
                  readonly prefix: 'postOptionalOneToMany_authorId_idx';
                  readonly columns: readonly ['authorId'];
                  readonly unique: false;
                },
              ];
