...
//
// Prisma 8's mongo `ObjectId` codec accepts a string input and encodes it to a BSON
...
//     `_id` on create, but Prisma 8's mongo `_id` is server-assigned and not settable via
