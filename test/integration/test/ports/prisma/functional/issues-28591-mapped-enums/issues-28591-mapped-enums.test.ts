...
//
// In Prisma 8, native_enum member values ARE the PG enum labels and the pg/enum@1
...
//
// Gap: Prisma 8 does not implement Prisma's @map-on-enum-member semantics (translating
  ...
  it.fails(
    ...
    () =>
      withIssue28591(async ({ db }) => {
        // In Prisma 8 the valid input value for status is the PG label 'pending',
        ...
        // translation). Prisma 8 returns the PG label 'pending' directly.
