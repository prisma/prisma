...
// `Temporal.Instant` rather than a `Date`. The values below are still `Date`s, and the checked-in
// `_fixture/generated` contract still names the retired codec — both move together when the
