...
- Caching every storage-hash database used by a Postgres port file cut two alternating-contract relation matrices from 69.80s to 20.07s locally and substantially improved their hosted per-file timings, but full CI critical paths of 548s and 569s both missed the retained 531s best. The change was discarded and retained in `.auto/ideas.md` for reconsideration with better shard-level profiling.
