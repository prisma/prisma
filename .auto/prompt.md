...
- Four-way Vitest sharding then reduced the retained 462s critical path to 324s (29.9%) and the maximum test step from 369s to 273s, preserving all 379 files / 2,129 tests across 95+95+95+94 files. That run used 1,172s of aggregate integration runner time versus 1,275s for the preceding three-shard run, but treat the apparent compute saving as hosted-runner variance until repeated.
