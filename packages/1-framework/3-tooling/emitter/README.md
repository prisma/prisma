...
The emitter is the core of Prisma 8's contract-first architecture. It takes authored data models (from PSL or TypeScript builders) and produces two deterministic artifacts:
