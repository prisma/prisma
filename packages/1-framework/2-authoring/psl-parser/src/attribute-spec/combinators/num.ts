...
export function num(): ArgType<number, AttributeCtx>;
export function num<const T extends number>(value: T): ArgType<T, AttributeCtx>;
export function num<const T extends number>(value?: T): ArgType<number | T, AttributeCtx> {
  return {
    kind: 'num',
