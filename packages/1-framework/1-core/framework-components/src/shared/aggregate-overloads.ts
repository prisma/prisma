 ...
 *
 * Settling is a pure function of the contributed overloads and the codecs they are settled against. It reports rather than throws: what an ambiguity means — a build failure, an emit failure — is the caller's to say.
 */
