...
describe('postgresql introspection stopgaps', () => {
  ...
  describe('postgres partitioned', () => {
    const stopGap = 'partitioned'
    const warningCode = 27

    describe('variant 1 - partitioned tables found', () => {
      const variant = 1
    ...
    describe('variant 2 - multiple partitioned tables found', () => {
      const variant = 2
      setupPostgresForWarning(stopGap, warningCode, variant)
...
describe('postgresql comments', () => {
  ...
  describe('postgres 36/1 - comments found, models & fields', () => {
  ...
  describe('postgres 36/2 - comments found, views & fields', () => {
    const stopGap = 'comments'
    const warningCode = 36
    const variant = 2
    setupPostgresForWarning(stopGap, warningCode, variant)
  ...
  describe('postgres 36/3 - comments found, types', () => {
    const stopGap = 'comments'
    const warningCode = 36
    const variant = 3
    setupPostgresForWarning(stopGap, warningCode, variant)
    ...
    test('basic introspection', async () => {
      ...
      expect(ctx.mocked['console.log'].mock.calls.join('\n')).toMatchInlineSnapshot(`
        ...
        // introspectionSchemaVersion: Prisma11,
