...
export const migrateDiffCompletion: CommandCompletion = {
  ...
  options: [
    ...
    { name: 'to-schema', description: 'Path to a Prisma schema file as the destination' },
    { name: 'to-migrations', description: 'Path to a Prisma migrations directory as the destination' },
    { name: 'to-config-datasource', description: 'Use the datasource from the Prisma config file as the destination' },
