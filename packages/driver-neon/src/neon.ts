...
export class PrismaNeonAdapter extends NeonWsQueryable<neon.Pool> implements SqlDriver {
...
export class PrismaNeonDriverFactory implements SqlDriverFactory {
  readonly provider = 'postgres'
  readonly driverName = packageName
...
export class PrismaNeonHttpAdapter extends NeonQueryable implements SqlDriver {
...
export class PrismaNeonHttpDriverFactory implements SqlDriverFactory {
  readonly provider = 'postgres'
  readonly driverName = packageName
