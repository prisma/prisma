/**
 * Production build virtual module generation for unplugin-refract
...
export class ProductionBuildManager {
  ...
  constructor(options: ProductionBuildOptions = {}, devOutput: DevOutput, buildContext: BuildContext) {
    this.options = {
      optimize: true,
      cache: true,
      cacheDir: 'node_modules/.cache/unplugin-refract',
  ...
  private createOptimizedTypesModule(generatedTypes: GeneratedTypes): string {
    const header = this.buildContext.isProduction
      ? '// Generated by unplugin-refract - production build'
      : '// Generated by unplugin-refract - development build'
...
export type { RefractClient, RefractClientOptions } from '@refract/client'`
  ...
  private createSourceMap(filename: string, content: string): string {
    ...
    const sourceMap = {
      version: 3,
      file: `${filename}.ts`,
      sources: [`virtual:refract/${filename}`],
      names: [],
