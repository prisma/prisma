/**
 * Virtual module system for unplugin-ork
 * Provides clean .ork/types imports like Next.js patterns
 */
...
export class VirtualModuleManager {
  ...
  private log(message: string) {
    if (this.debug) {
      console.log(`[unplugin-ork:virtual] ${message}`)
    }
  }
...
export class VirtualModuleResolver {
  private readonly VIRTUAL_PREFIX = 'virtual:ork/'
  private readonly ORK_PREFIX = '.ork/'

  /**
   * Check if an import ID should be handled as a virtual module
   */
  isVirtualModule(id: string): boolean {
    return id.startsWith(this.ORK_PREFIX) || id.startsWith(this.VIRTUAL_PREFIX)
  }

  /**
   * Convert a .ork import to virtual module ID
   */
  resolveVirtualId(id: string): string | null {
    if (id.startsWith(this.ORK_PREFIX)) {
      // Convert .ork/types -> virtual:ork/types
      const relativePath = id.replace(this.ORK_PREFIX, '')
  ...
  getImportPatterns(moduleKey: string): string[] {
    return [`${this.ORK_PREFIX}${moduleKey}`, `${this.VIRTUAL_PREFIX}${moduleKey}`]
  }
}
...
export class VirtualTypeGenerator {
  ...
  private log(message: string) {
    if (this.debug) {
      console.log(`[unplugin-ork:types] ${message}`)
    }
  }
  ...
  generateTypesModule(generatedTypes: GeneratedTypes): string {
    ...
    return `// Generated by unplugin-ork - do not edit manually
// This file provides clean .ork/types imports for the Ork blessed path
...
`
  ...
  /**
   * Generate index module for the .ork directory
   */
  generateIndexModule(generatedTypes: GeneratedTypes, hasClientModule = false): string {
    ...
    const baseExports = `// Generated index for .ork directory
export * from './types'
...
throw new Error(${JSON.stringify(`Ork schema error: ${error}`)})
...
`
  ...
  generateClientModule(generatedClientCode: GeneratedClientCode): string {
    ...
    return `// Generated Ork Client - do not edit manually
// This file provides the complete generated Ork client
...
`
  ...
  generateClientTypesModule(generatedClientCode: GeneratedClientCode): string {
    ...
    return `// Generated Ork Client Types - do not edit manually
...
export const __ORK_SETUP_REQUIRED__ = 'Client generation failed. Use manual setup with OrkClient class.'
`
  }
  ...
  generateFallbackClientTypesModule(): string {
    ...
    return `// Fallback Ork Client Types
