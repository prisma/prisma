...
import { deepGet, deepSet } from '../src/runtime/utils/deep-set'
...
export interface ArtistDelegate {
  <T extends ArtistArgs>(args: Subset<T, ArtistArgs>): PromiseLike<
    Array<ArtistGetPayload<ExtractFindManyArtistArgsSelect<T>>>
  >
  ...
  updateMany<T extends ArtistUpdateManyArgs>(
    ...
    ? PromiseLike<ArtistGetPayload<ExtractArtistUpdateManyArgsSelect<T>>>
    : ArtistClient<Artist>
  ...
  deleteMany<T extends ArtistDeleteManyArgs>(
    ...
    ? PromiseLike<ArtistGetPayload<ExtractArtistDeleteManyArgsSelect<T>>>
    : ArtistClient<Artist>
}
function ArtistDelegate(dmmf: DMMFClass, fetcher: PrismaFetcher): ArtistDelegate {
  const Artist = <T extends ArtistArgs>(args: Subset<T, ArtistArgs>) =>
    new ArtistClient<PromiseLike<Array<ArtistGetPayload<ExtractFindManyArtistArgsSelect<T>>>>>(
      dmmf,
      fetcher,
      'query',
      'artists',
  ...
  Artist.findOne = <T extends FindOneArtistArgs>(args: Subset<T, FindOneArtistArgs>) =>
    args.select
      ? new ArtistClient<Array<ArtistGetPayload<ExtractFindOneArtistArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'query',
          'artist',
      ...
      : new ArtistClient<Artist>(dmmf, fetcher, 'query', 'artist', 'artists.findOne', args, [])
  Artist.findMany = <T extends FindManyArtistArgs>(args: Subset<T, FindManyArtistArgs>) =>
    new ArtistClient<Array<ArtistGetPayload<ExtractFindManyArtistArgsSelect<T>>>>(
      dmmf,
      fetcher,
      'query',
      'artists',
  ...
  Artist.create = <T extends ArtistCreateArgs>(args: Subset<T, ArtistCreateArgs>) =>
    args.select
      ? new ArtistClient<Array<ArtistGetPayload<ExtractArtistCreateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'createArtist',
      ...
      : new ArtistClient<Artist>(dmmf, fetcher, 'mutation', 'createArtist', 'artists.create', args, [])
  Artist.update = <T extends ArtistUpdateArgs>(args: Subset<T, ArtistUpdateArgs>) =>
    args.select
      ? new ArtistClient<Array<ArtistGetPayload<ExtractArtistUpdateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateArtist',
      ...
      : new ArtistClient<Artist>(dmmf, fetcher, 'mutation', 'updateArtist', 'artists.update', args, [])
  Artist.updateMany = <T extends ArtistUpdateManyArgs>(args: Subset<T, ArtistUpdateManyArgs>) =>
    args.select
      ? new ArtistClient<Array<ArtistGetPayload<ExtractArtistUpdateManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateManyArtists',
      ...
      : new ArtistClient<Artist>(dmmf, fetcher, 'mutation', 'updateManyArtists', 'artists.updateMany', args, [])
  Artist.upsert = <T extends ArtistUpsertArgs>(args: Subset<T, ArtistUpsertArgs>) =>
    args.select
      ? new ArtistClient<Array<ArtistGetPayload<ExtractArtistUpsertArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'upsertArtist',
      ...
      : new ArtistClient<Artist>(dmmf, fetcher, 'mutation', 'upsertArtist', 'artists.upsert', args, [])
  Artist.delete = <T extends ArtistDeleteArgs>(args: Subset<T, ArtistDeleteArgs>) =>
    args.select
      ? new ArtistClient<Array<ArtistGetPayload<ExtractArtistDeleteArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteArtist',
      ...
      : new ArtistClient<Artist>(dmmf, fetcher, 'mutation', 'deleteArtist', 'artists.delete', args, [])
  Artist.deleteMany = <T extends ArtistDeleteManyArgs>(args: Subset<T, ArtistDeleteManyArgs>) =>
    args.select
      ? new ArtistClient<Array<ArtistGetPayload<ExtractArtistDeleteManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteManyArtists',
      ...
      : new ArtistClient<Artist>(dmmf, fetcher, 'mutation', 'deleteManyArtists', 'artists.deleteMany', args, [])
...
class ArtistClient<T> implements PromiseLike<T> {
  ...
  Albums<T extends FindManyAlbumArgs = {}>(
    ...
    return this._Albums
      ? this._Albums
      : ((this._Albums = new AlbumClient<Array<AlbumGetPayload<ExtractFindManyAlbumArgsSelect<T>>>>(
          this.dmmf,
          this.fetcher,
          this.queryType,
          this.rootField,
...
export interface AlbumDelegate {
  <T extends AlbumArgs>(args: Subset<T, AlbumArgs>): PromiseLike<
    Array<AlbumGetPayload<ExtractFindManyAlbumArgsSelect<T>>>
  >
...
function AlbumDelegate(dmmf: DMMFClass, fetcher: PrismaFetcher): AlbumDelegate {
  const Album = <T extends AlbumArgs>(args: Subset<T, AlbumArgs>) =>
    new AlbumClient<PromiseLike<Array<AlbumGetPayload<ExtractFindManyAlbumArgsSelect<T>>>>>(
      dmmf,
      fetcher,
      'query',
      'albums',
  ...
  Album.findOne = <T extends FindOneAlbumArgs>(args: Subset<T, FindOneAlbumArgs>) =>
    args.select
      ? new AlbumClient<Array<AlbumGetPayload<ExtractFindOneAlbumArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'query',
          'album',
      ...
      : new AlbumClient<Album>(dmmf, fetcher, 'query', 'album', 'albums.findOne', args, [])
  Album.findMany = <T extends FindManyAlbumArgs>(args: Subset<T, FindManyAlbumArgs>) =>
    new AlbumClient<Array<AlbumGetPayload<ExtractFindManyAlbumArgsSelect<T>>>>(
      dmmf,
      fetcher,
      'query',
      'albums',
  ...
  Album.create = <T extends AlbumCreateArgs>(args: Subset<T, AlbumCreateArgs>) =>
    args.select
      ? new AlbumClient<Array<AlbumGetPayload<ExtractAlbumCreateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'createAlbum',
      ...
      : new AlbumClient<Album>(dmmf, fetcher, 'mutation', 'createAlbum', 'albums.create', args, [])
  Album.update = <T extends AlbumUpdateArgs>(args: Subset<T, AlbumUpdateArgs>) =>
    args.select
      ? new AlbumClient<Array<AlbumGetPayload<ExtractAlbumUpdateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateAlbum',
      ...
      : new AlbumClient<Album>(dmmf, fetcher, 'mutation', 'updateAlbum', 'albums.update', args, [])
  Album.updateMany = <T extends AlbumUpdateManyArgs>(args: Subset<T, AlbumUpdateManyArgs>) =>
    args.select
      ? new AlbumClient<Array<AlbumGetPayload<ExtractAlbumUpdateManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateManyAlbums',
      ...
      : new AlbumClient<Album>(dmmf, fetcher, 'mutation', 'updateManyAlbums', 'albums.updateMany', args, [])
  Album.upsert = <T extends AlbumUpsertArgs>(args: Subset<T, AlbumUpsertArgs>) =>
    args.select
      ? new AlbumClient<Array<AlbumGetPayload<ExtractAlbumUpsertArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'upsertAlbum',
      ...
      : new AlbumClient<Album>(dmmf, fetcher, 'mutation', 'upsertAlbum', 'albums.upsert', args, [])
  Album.delete = <T extends AlbumDeleteArgs>(args: Subset<T, AlbumDeleteArgs>) =>
    args.select
      ? new AlbumClient<Array<AlbumGetPayload<ExtractAlbumDeleteArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteAlbum',
      ...
      : new AlbumClient<Album>(dmmf, fetcher, 'mutation', 'deleteAlbum', 'albums.delete', args, [])
  Album.deleteMany = <T extends AlbumDeleteManyArgs>(args: Subset<T, AlbumDeleteManyArgs>) =>
    args.select
      ? new AlbumClient<Array<AlbumGetPayload<ExtractAlbumDeleteManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteManyAlbums',
      ...
      : new AlbumClient<Album>(dmmf, fetcher, 'mutation', 'deleteManyAlbums', 'albums.deleteMany', args, [])
...
class AlbumClient<T> implements PromiseLike<T> {
  ...
  Artist<T extends ArtistArgs = {}>(
    args?: Subset<T, ArtistArgs>,
  ): 'select' extends keyof T ? PromiseLike<ArtistGetPayload<ExtractArtistArgsSelect<T>>> : ArtistClient<Artist> {
    const path = [...this.path, 'select', 'Artist']
    const newArgs = deepSet(this.args, path, args || true)
    return this._Artist
      ? this._Artist
      : ((this._Artist = new ArtistClient<
          'select' extends keyof T ? ArtistGetPayload<ExtractArtistArgsSelect<T>> : ArtistClient<Artist>
  ...
  Tracks<T extends FindManyTrackArgs = {}>(
    ...
    return this._Tracks
      ? this._Tracks
      : ((this._Tracks = new TrackClient<Array<TrackGetPayload<ExtractFindManyTrackArgsSelect<T>>>>(
          this.dmmf,
          this.fetcher,
          this.queryType,
          this.rootField,
...
export interface TrackDelegate {
  <T extends TrackArgs>(args: Subset<T, TrackArgs>): PromiseLike<
    Array<TrackGetPayload<ExtractFindManyTrackArgsSelect<T>>>
  >
...
function TrackDelegate(dmmf: DMMFClass, fetcher: PrismaFetcher): TrackDelegate {
  const Track = <T extends TrackArgs>(args: Subset<T, TrackArgs>) =>
    new TrackClient<PromiseLike<Array<TrackGetPayload<ExtractFindManyTrackArgsSelect<T>>>>>(
      dmmf,
      fetcher,
      'query',
      'tracks',
  ...
  Track.findOne = <T extends FindOneTrackArgs>(args: Subset<T, FindOneTrackArgs>) =>
    args.select
      ? new TrackClient<Array<TrackGetPayload<ExtractFindOneTrackArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'query',
          'track',
      ...
      : new TrackClient<Track>(dmmf, fetcher, 'query', 'track', 'tracks.findOne', args, [])
  Track.findMany = <T extends FindManyTrackArgs>(args: Subset<T, FindManyTrackArgs>) =>
    new TrackClient<Array<TrackGetPayload<ExtractFindManyTrackArgsSelect<T>>>>(
      dmmf,
      fetcher,
      'query',
      'tracks',
  ...
  Track.create = <T extends TrackCreateArgs>(args: Subset<T, TrackCreateArgs>) =>
    args.select
      ? new TrackClient<Array<TrackGetPayload<ExtractTrackCreateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'createTrack',
      ...
      : new TrackClient<Track>(dmmf, fetcher, 'mutation', 'createTrack', 'tracks.create', args, [])
  Track.update = <T extends TrackUpdateArgs>(args: Subset<T, TrackUpdateArgs>) =>
    args.select
      ? new TrackClient<Array<TrackGetPayload<ExtractTrackUpdateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateTrack',
      ...
      : new TrackClient<Track>(dmmf, fetcher, 'mutation', 'updateTrack', 'tracks.update', args, [])
  Track.updateMany = <T extends TrackUpdateManyArgs>(args: Subset<T, TrackUpdateManyArgs>) =>
    args.select
      ? new TrackClient<Array<TrackGetPayload<ExtractTrackUpdateManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateManyTracks',
      ...
      : new TrackClient<Track>(dmmf, fetcher, 'mutation', 'updateManyTracks', 'tracks.updateMany', args, [])
  Track.upsert = <T extends TrackUpsertArgs>(args: Subset<T, TrackUpsertArgs>) =>
    args.select
      ? new TrackClient<Array<TrackGetPayload<ExtractTrackUpsertArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'upsertTrack',
      ...
      : new TrackClient<Track>(dmmf, fetcher, 'mutation', 'upsertTrack', 'tracks.upsert', args, [])
  Track.delete = <T extends TrackDeleteArgs>(args: Subset<T, TrackDeleteArgs>) =>
    args.select
      ? new TrackClient<Array<TrackGetPayload<ExtractTrackDeleteArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteTrack',
      ...
      : new TrackClient<Track>(dmmf, fetcher, 'mutation', 'deleteTrack', 'tracks.delete', args, [])
  Track.deleteMany = <T extends TrackDeleteManyArgs>(args: Subset<T, TrackDeleteManyArgs>) =>
    args.select
      ? new TrackClient<Array<TrackGetPayload<ExtractTrackDeleteManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteManyTracks',
      ...
      : new TrackClient<Track>(dmmf, fetcher, 'mutation', 'deleteManyTracks', 'tracks.deleteMany', args, [])
...
class TrackClient<T> implements PromiseLike<T> {
  ...
  ): 'select' extends keyof T ? PromiseLike<AlbumGetPayload<ExtractAlbumArgsSelect<T>>> : AlbumClient<Album> {
    const path = [...this.path, 'select', 'Album']
    const newArgs = deepSet(this.args, path, args || true)
    return this._Album
      ? this._Album
      : ((this._Album = new AlbumClient<
          'select' extends keyof T ? AlbumGetPayload<ExtractAlbumArgsSelect<T>> : AlbumClient<Album>
        >(this.dmmf, this.fetcher, this.queryType, this.rootField, this.clientMethod, newArgs, path)) as any)
  }
  private _MediaType?: MediaTypeClient<any>
  MediaType<T extends MediaTypeArgs = {}>(
    args?: Subset<T, MediaTypeArgs>,
  ): 'select' extends keyof T
    ? PromiseLike<MediaTypeGetPayload<ExtractMediaTypeArgsSelect<T>>>
    : MediaTypeClient<MediaType> {
    const path = [...this.path, 'select', 'MediaType']
    const newArgs = deepSet(this.args, path, args || true)
    return this._MediaType
      ? this._MediaType
      : ((this._MediaType = new MediaTypeClient<
          'select' extends keyof T ? MediaTypeGetPayload<ExtractMediaTypeArgsSelect<T>> : MediaTypeClient<MediaType>
        >(this.dmmf, this.fetcher, this.queryType, this.rootField, this.clientMethod, newArgs, path)) as any)
  }
  private _Genre?: GenreClient<any>
  Genre<T extends GenreArgs = {}>(
    args?: Subset<T, GenreArgs>,
  ): 'select' extends keyof T ? PromiseLike<GenreGetPayload<ExtractGenreArgsSelect<T>>> : GenreClient<Genre> {
    const path = [...this.path, 'select', 'Genre']
    const newArgs = deepSet(this.args, path, args || true)
    return this._Genre
      ? this._Genre
      : ((this._Genre = new GenreClient<
          'select' extends keyof T ? GenreGetPayload<ExtractGenreArgsSelect<T>> : GenreClient<Genre>
        >(this.dmmf, this.fetcher, this.queryType, this.rootField, this.clientMethod, newArgs, path)) as any)
  }
...
export interface GenreDelegate {
  <T extends GenreArgs>(args: Subset<T, GenreArgs>): PromiseLike<
    Array<GenreGetPayload<ExtractFindManyGenreArgsSelect<T>>>
  >
...
function GenreDelegate(dmmf: DMMFClass, fetcher: PrismaFetcher): GenreDelegate {
  const Genre = <T extends GenreArgs>(args: Subset<T, GenreArgs>) =>
    new GenreClient<PromiseLike<Array<GenreGetPayload<ExtractFindManyGenreArgsSelect<T>>>>>(
      dmmf,
      fetcher,
      'query',
      'genres',
  ...
  Genre.findOne = <T extends FindOneGenreArgs>(args: Subset<T, FindOneGenreArgs>) =>
    args.select
      ? new GenreClient<Array<GenreGetPayload<ExtractFindOneGenreArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'query',
          'genre',
      ...
      : new GenreClient<Genre>(dmmf, fetcher, 'query', 'genre', 'genres.findOne', args, [])
  Genre.findMany = <T extends FindManyGenreArgs>(args: Subset<T, FindManyGenreArgs>) =>
    new GenreClient<Array<GenreGetPayload<ExtractFindManyGenreArgsSelect<T>>>>(
      dmmf,
      fetcher,
      'query',
      'genres',
  ...
  Genre.create = <T extends GenreCreateArgs>(args: Subset<T, GenreCreateArgs>) =>
    args.select
      ? new GenreClient<Array<GenreGetPayload<ExtractGenreCreateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'createGenre',
      ...
      : new GenreClient<Genre>(dmmf, fetcher, 'mutation', 'createGenre', 'genres.create', args, [])
  Genre.update = <T extends GenreUpdateArgs>(args: Subset<T, GenreUpdateArgs>) =>
    args.select
      ? new GenreClient<Array<GenreGetPayload<ExtractGenreUpdateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateGenre',
      ...
      : new GenreClient<Genre>(dmmf, fetcher, 'mutation', 'updateGenre', 'genres.update', args, [])
  Genre.updateMany = <T extends GenreUpdateManyArgs>(args: Subset<T, GenreUpdateManyArgs>) =>
    args.select
      ? new GenreClient<Array<GenreGetPayload<ExtractGenreUpdateManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateManyGenres',
      ...
      : new GenreClient<Genre>(dmmf, fetcher, 'mutation', 'updateManyGenres', 'genres.updateMany', args, [])
  Genre.upsert = <T extends GenreUpsertArgs>(args: Subset<T, GenreUpsertArgs>) =>
    args.select
      ? new GenreClient<Array<GenreGetPayload<ExtractGenreUpsertArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'upsertGenre',
      ...
      : new GenreClient<Genre>(dmmf, fetcher, 'mutation', 'upsertGenre', 'genres.upsert', args, [])
  Genre.delete = <T extends GenreDeleteArgs>(args: Subset<T, GenreDeleteArgs>) =>
    args.select
      ? new GenreClient<Array<GenreGetPayload<ExtractGenreDeleteArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteGenre',
      ...
      : new GenreClient<Genre>(dmmf, fetcher, 'mutation', 'deleteGenre', 'genres.delete', args, [])
  Genre.deleteMany = <T extends GenreDeleteManyArgs>(args: Subset<T, GenreDeleteManyArgs>) =>
    args.select
      ? new GenreClient<Array<GenreGetPayload<ExtractGenreDeleteManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteManyGenres',
      ...
      : new GenreClient<Genre>(dmmf, fetcher, 'mutation', 'deleteManyGenres', 'genres.deleteMany', args, [])
...
export interface MediaTypeDelegate {
  <T extends MediaTypeArgs>(args: Subset<T, MediaTypeArgs>): PromiseLike<
    Array<MediaTypeGetPayload<ExtractFindManyMediaTypeArgsSelect<T>>>
  >
  findOne<T extends FindOneMediaTypeArgs>(
    args: Subset<T, FindOneMediaTypeArgs>,
  ): 'select' extends keyof T
    ? PromiseLike<MediaTypeGetPayload<ExtractFindOneMediaTypeArgsSelect<T>>>
    : MediaTypeClient<MediaType>
  ...
  create<T extends MediaTypeCreateArgs>(
    ...
    ? PromiseLike<MediaTypeGetPayload<ExtractMediaTypeCreateArgsSelect<T>>>
    : MediaTypeClient<MediaType>
  update<T extends MediaTypeUpdateArgs>(
    args: Subset<T, MediaTypeUpdateArgs>,
  ): 'select' extends keyof T
    ? PromiseLike<MediaTypeGetPayload<ExtractMediaTypeUpdateArgsSelect<T>>>
    : MediaTypeClient<MediaType>
  updateMany<T extends MediaTypeUpdateManyArgs>(
    args: Subset<T, MediaTypeUpdateManyArgs>,
  ): 'select' extends keyof T
    ? PromiseLike<MediaTypeGetPayload<ExtractMediaTypeUpdateManyArgsSelect<T>>>
    : MediaTypeClient<MediaType>
  upsert<T extends MediaTypeUpsertArgs>(
    args: Subset<T, MediaTypeUpsertArgs>,
  ): 'select' extends keyof T
    ? PromiseLike<MediaTypeGetPayload<ExtractMediaTypeUpsertArgsSelect<T>>>
    : MediaTypeClient<MediaType>
  delete<T extends MediaTypeDeleteArgs>(
    args: Subset<T, MediaTypeDeleteArgs>,
  ): 'select' extends keyof T
    ? PromiseLike<MediaTypeGetPayload<ExtractMediaTypeDeleteArgsSelect<T>>>
    : MediaTypeClient<MediaType>
  deleteMany<T extends MediaTypeDeleteManyArgs>(
    args: Subset<T, MediaTypeDeleteManyArgs>,
  ): 'select' extends keyof T
    ? PromiseLike<MediaTypeGetPayload<ExtractMediaTypeDeleteManyArgsSelect<T>>>
    : MediaTypeClient<MediaType>
}
function MediaTypeDelegate(dmmf: DMMFClass, fetcher: PrismaFetcher): MediaTypeDelegate {
  const MediaType = <T extends MediaTypeArgs>(args: Subset<T, MediaTypeArgs>) =>
    new MediaTypeClient<PromiseLike<Array<MediaTypeGetPayload<ExtractFindManyMediaTypeArgsSelect<T>>>>>(
      dmmf,
      fetcher,
      'query',
      'mediaTypes',
  ...
  MediaType.findOne = <T extends FindOneMediaTypeArgs>(args: Subset<T, FindOneMediaTypeArgs>) =>
    args.select
      ? new MediaTypeClient<Array<MediaTypeGetPayload<ExtractFindOneMediaTypeArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'query',
          'mediaType',
      ...
      : new MediaTypeClient<MediaType>(dmmf, fetcher, 'query', 'mediaType', 'mediaTypes.findOne', args, [])
  MediaType.findMany = <T extends FindManyMediaTypeArgs>(args: Subset<T, FindManyMediaTypeArgs>) =>
    new MediaTypeClient<Array<MediaTypeGetPayload<ExtractFindManyMediaTypeArgsSelect<T>>>>(
      dmmf,
      fetcher,
      'query',
      'mediaTypes',
  ...
  MediaType.create = <T extends MediaTypeCreateArgs>(args: Subset<T, MediaTypeCreateArgs>) =>
    args.select
      ? new MediaTypeClient<Array<MediaTypeGetPayload<ExtractMediaTypeCreateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'createMediaType',
      ...
      : new MediaTypeClient<MediaType>(dmmf, fetcher, 'mutation', 'createMediaType', 'mediaTypes.create', args, [])
  MediaType.update = <T extends MediaTypeUpdateArgs>(args: Subset<T, MediaTypeUpdateArgs>) =>
    args.select
      ? new MediaTypeClient<Array<MediaTypeGetPayload<ExtractMediaTypeUpdateArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'updateMediaType',
      ...
      : new MediaTypeClient<MediaType>(dmmf, fetcher, 'mutation', 'updateMediaType', 'mediaTypes.update', args, [])
  MediaType.updateMany = <T extends MediaTypeUpdateManyArgs>(args: Subset<T, MediaTypeUpdateManyArgs>) =>
    args.select
      ? new MediaTypeClient<Array<MediaTypeGetPayload<ExtractMediaTypeUpdateManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
  ...
  MediaType.upsert = <T extends MediaTypeUpsertArgs>(args: Subset<T, MediaTypeUpsertArgs>) =>
    args.select
      ? new MediaTypeClient<Array<MediaTypeGetPayload<ExtractMediaTypeUpsertArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'upsertMediaType',
      ...
      : new MediaTypeClient<MediaType>(dmmf, fetcher, 'mutation', 'upsertMediaType', 'mediaTypes.upsert', args, [])
  MediaType.delete = <T extends MediaTypeDeleteArgs>(args: Subset<T, MediaTypeDeleteArgs>) =>
    args.select
      ? new MediaTypeClient<Array<MediaTypeGetPayload<ExtractMediaTypeDeleteArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
          'deleteMediaType',
      ...
      : new MediaTypeClient<MediaType>(dmmf, fetcher, 'mutation', 'deleteMediaType', 'mediaTypes.delete', args, [])
  MediaType.deleteMany = <T extends MediaTypeDeleteManyArgs>(args: Subset<T, MediaTypeDeleteManyArgs>) =>
    args.select
      ? new MediaTypeClient<Array<MediaTypeGetPayload<ExtractMediaTypeDeleteManyArgsSelect<T>>>>(
          dmmf,
          fetcher,
          'mutation',
