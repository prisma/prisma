...
/**
 * Node.js based wrapper to run the Prisma Query engine binary
 */
...
export class BinaryEngine extends Engine {
   ...
   * As soon as the Prisma query engine binary returns a correct return code (like 1 or 0), we don't need this anymore
   */
  constructor({
    cwd,
    datamodelPath,
