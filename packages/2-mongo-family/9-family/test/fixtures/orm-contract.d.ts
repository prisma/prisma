  ...
  readonly domain: {
    readonly namespaces: {
      readonly __unbound__: {
        readonly models: { readonly Address: { readonly fields: { readonly street: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly city: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly zip: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } } }; readonly relations: Record<string, never>; readonly storage: Record<string, never>; readonly owner: 'User' }; readonly Bug: { readonly fields: { readonly severity: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } } }; readonly relations: Record<string, never>; readonly storage: { readonly collection: 'tasks' }; readonly base: { readonly namespace: '__unbound__' & NamespaceId; readonly model: 'Task' } }; readonly Comment: { readonly fields: { readonly _id: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/objectId@1' } }; readonly text: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly createdAt: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/date@1' } } }; readonly relations: Record<string, never>; readonly storage: Record<string, never>; readonly owner: 'Task' }; readonly Feature: { readonly fields: { readonly priority: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly targetRelease: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } } }; readonly relations: Record<string, never>; readonly storage: { readonly collection: 'tasks' }; readonly base: { readonly namespace: '__unbound__' & NamespaceId; readonly model: 'Task' } }; readonly Task: { readonly fields: { readonly _id: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/objectId@1' } }; readonly title: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly type: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly assigneeId: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/objectId@1' } } }; readonly relations: { readonly assignee: { readonly to: { readonly namespace: '__unbound__' & NamespaceId; readonly model: 'User' }; readonly cardinality: 'N:1'; readonly on: { readonly localFields: readonly ['assigneeId']; readonly targetFields: readonly ['_id'] } }; readonly comments: { readonly to: { readonly namespace: '__unbound__' & NamespaceId; readonly model: 'Comment' }; readonly cardinality: '1:N' } }; readonly storage: { readonly collection: 'tasks'; readonly relations: { readonly comments: { readonly field: 'comments' } } }; readonly discriminator: { readonly field: 'type' }; readonly variants: { readonly Bug: { readonly value: 'bug' }; readonly Feature: { readonly value: 'feature' } } }; readonly User: { readonly fields: { readonly _id: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/objectId@1' } }; readonly name: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly email: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly loginCount: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/int32@1' } }; readonly tags: { readonly nullable: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' }; readonly many: { readonly elementNullable: false } }; readonly homeAddress: { readonly nullable: true; readonly many: false; readonly type: { readonly kind: 'valueObject'; readonly name: 'HomeAddress' } } }; readonly relations: { readonly addresses: { readonly to: { readonly namespace: '__unbound__' & NamespaceId; readonly model: 'Address' }; readonly cardinality: '1:N' }; readonly tasks: { readonly to: { readonly namespace: '__unbound__' & NamespaceId; readonly model: 'Task' }; readonly cardinality: '1:N'; readonly on: { readonly localFields: readonly ['_id']; readonly targetFields: readonly ['assigneeId'] } } }; readonly storage: { readonly collection: 'users'; readonly relations: { readonly addresses: { readonly field: 'addresses' } } } } };
        readonly valueObjects: { readonly HomeAddress: { readonly fields: { readonly city: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } }; readonly country: { readonly nullable: false; readonly many: false; readonly type: { readonly kind: 'scalar'; readonly codecId: 'mongo/string@1' } } } } };
      };
    };
  };
