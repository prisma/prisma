...
export class PrismaMariaDbAdapter extends MariaDbQueryable<mariadb.Pool> implements SqlDriver {
  constructor(
    client: mariadb.Pool,
...
export class PrismaMariaDbDriverFactory implements SqlDriverFactory {
  readonly provider = 'mysql'
  readonly driverName = packageName
