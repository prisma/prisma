...
import { Debug, DriverAdapterError } from '@prisma/driver-utils'
...
export type UserDefinedTypeParser = (oid: number, value: unknown, driver: SqlQueryable) => Promise<unknown>

export class PrismaPgAdapter extends PgQueryable<StdClient> implements SqlDriver {
  constructor(
    client: StdClient,
    protected readonly pgOptions?: PrismaPgOptions,
...
export class PrismaPgDriverFactory implements SqlMigrationAwareDriverFactory {
  readonly provider = 'postgres'
  readonly driverName = packageName
