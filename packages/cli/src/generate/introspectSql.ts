...
import { inferDirectoryConfig, isValidJsIdentifier, SchemaContext } from '@prisma/internals'
...
export async function introspectSql(config: PrismaConfigInternal, schemaContext: SchemaContext) {
