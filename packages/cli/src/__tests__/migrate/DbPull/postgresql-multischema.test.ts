...
import { SetupParams, setupPostgres, tearDownPostgres } from '../../../migrate/utils/setupPostgres'
...
describe('postgresql-multischema', () => {
  ...
  const setupParams: SetupParams = {
    ...
    dirname: path.join(__dirname, '..', '..', 'fixtures', 'introspection', 'postgresql-multischema'),
  }
