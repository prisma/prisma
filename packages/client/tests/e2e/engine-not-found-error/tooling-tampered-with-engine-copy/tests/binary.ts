...
This is likely caused by tooling that has not copied "query-engine-debian-openssl-1.1.x" to the deployment.
Please try to make sure that "query-engine-debian-openssl-1.1.x" is copied to "prisma/client".
