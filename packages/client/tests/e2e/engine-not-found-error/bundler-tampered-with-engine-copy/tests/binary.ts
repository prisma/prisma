...
This is likely caused by a bundler that has not copied "query-engine-debian-openssl-1.1.x" near the resulting bundle.
Please try to make sure that "query-engine-debian-openssl-1.1.x" is copied right near your bundle or "prisma/client".
