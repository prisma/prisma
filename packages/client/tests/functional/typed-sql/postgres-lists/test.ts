...
testMatrix.setupTestSuite(
  () => {
    ...
    test('int - output', async () => {
      ...
      expectTypeOf(result[0].int).toEqualTypeOf<number[]>()
    })
    ...
    test('real - output', async () => {
      ...
      expectTypeOf(result[0].real).toEqualTypeOf<number[]>()
    })
    ...
    test('double - output', async () => {
      ...
      expectTypeOf(result[0].double).toEqualTypeOf<number[]>()
    })
    ...
    test('string - output', async () => {
      ...
      expectTypeOf(result[0].string).toEqualTypeOf<string[]>()
    })
