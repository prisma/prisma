 ...
 */
export type ${generatedName}<ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs> = {
 ...
 */
export type ${typeName}<ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs> = {
${indent(
  args
    .map((arg) => {
