...
function clientTypeMapDefinition(this: PrismaClientClass) {
  ...
  return `
interface TypeMapCb extends $Utils.Fn<{extArgs: $Extensions.ExtensionArgs}, $Utils.Record<string, any>> {
  returns: Prisma.TypeMap<this['params']['extArgs']>
}

export type TypeMap<ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs> = ${typeMap}`
}
...
export class PrismaClient<
  ...
  ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs
> {
