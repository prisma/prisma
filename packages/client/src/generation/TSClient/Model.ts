...
export type ${groupByArgsName}<ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs> = {
${indent(
...
export type ${aggregateArgsName}<ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs> = {
${indent(
...
${
  availableActions.includes(DMMF.ModelAction.aggregate)
    ? `type ${countArgsName}<ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs> = 
...
export interface ${name}Delegate<ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs> {
 ...
 */
export interface Prisma__${name}Client<T, Null = never, ExtArgs extends $Extensions.ExtensionArgs = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
