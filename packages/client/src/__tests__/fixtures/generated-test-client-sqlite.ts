 ...
 * 
 * Generated at: 2026-01-12T21:39:55.519Z
 */

import { OrkClientBase } from '@ork/client'
import { createKyselyDialect, loadOrkConfig } from '@ork/config'
...
class UserOperations {
  ...
  private transformSelectResult(row: UserRow): UserScalars {
    ...
    result.createdAt = new Date(row.createdAt as string | number)
    
    result.updatedAt = new Date(row.updatedAt as string | number)
...
class PostOperations {
  ...
  private transformSelectResult(row: PostRow): PostScalars {
    ...
    result.published = row.published === 1
