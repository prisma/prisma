...
test('missing-engine: library', async () => {
  ...
  await expect(async () => {
    ...
    Please try to make sure that "libquery_engine-TEST_PLATFORM.LIBRARY_TYPE.node" is copied to "src/__tests__/integration/errors/missing-engine/node_modules/.prisma/client".
