...
test('missing-engine-native-binaryTarget: library', async () => {
  ...
  await expect(async () => {
    ...
    Please try to make sure that "TEST_PLATFORM" is copied to "src/__tests__/integration/errors/missing-engine-native-binaryTarget/node_modules/.prisma/client".
