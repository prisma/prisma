...
export const PG_INT8_NUMBER_CODEC_ID = 'pg/int8number@1' as const;
...
export const PG_UNBOUNDED_INT_CODEC_ID = 'pg/unboundedint@1' as const;
...
export const PG_INET_CODEC_ID = 'pg/inet@1' as const;
