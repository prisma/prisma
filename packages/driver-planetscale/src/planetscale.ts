...
export class PrismaPlanetScaleAdapter extends PlanetScaleQueryable<planetScale.Client> implements SqlDriver {
...
export class PrismaPlanetScaleDriverFactory implements SqlDriverFactory {
  readonly provider = 'mysql'
  readonly driverName = packageName
