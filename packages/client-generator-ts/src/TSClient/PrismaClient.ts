...
export interface PrismaClientConstructor {
  ...
  new <
    ...
    OmitOpts extends Partial<Prisma.PrismaClientOptions['omit']> = Options extends { omit?: infer U } ? U : {},
...
export interface PrismaClient<
  in LogOpts = {},
  in out OmitOpts extends Partial<Prisma.PrismaClientOptions['omit']> = {},
