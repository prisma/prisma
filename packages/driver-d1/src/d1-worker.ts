...
export class PrismaD1WorkerAdapter extends D1WorkerQueryable<StdClient> implements SqlDriver {
  readonly tags = {
...
export class PrismaD1WorkerDriverFactory implements SqlDriverFactory {
  readonly provider = 'sqlite'
  readonly driverName = packageName
