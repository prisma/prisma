...
SELECT setval('categories_categoryid_seq', 8);
...
SELECT setval('customers_customerid_seq', 91);
...
SELECT setval('shippers_shipperid_seq', 3);
...
SELECT setval('suppliers_supplierid_seq', 29);
...
SELECT setval('products_productid_seq', 77);
...
SELECT setval('orders_orderid_seq', 10443);
...
SELECT setval('orderdetails_orderdetailid_seq', 518);
