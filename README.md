...
The agent loads the `prisma-next` skill, opens its contract and queries references, then drives the change end-to-end.
...
Ask your agent. The `prisma-next` skill's feedback flow drafts a structured GitHub issue or hands you a Prisma Discord link for live Q&A. You can review and confirm before anything is submitted.
