...
test('missing-binary-native', async () => {
  ...
  await expect(async () => {
    await prisma.user.findMany()
          ...
          (Prisma Client looked in "/client/src/__tests__/integration/errors/missing-binary-native/node_modules/@prisma/client/runtime/commonjs/query-engine-TEST_PLATFORM")

          Searched Locations:

            /client/src/__tests__/integration/errors/missing-binary-native/node_modules/@prisma/.prisma/client
            /client/src/__tests__/integration/errors/missing-binary-native/node_modules/@prisma/client/runtime/commonjs
