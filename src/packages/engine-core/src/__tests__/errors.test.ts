...
describe('getErrorMessageWithLink', () => {
  test('basic serialization', () => {
    ...
    expect(
      ...
      https://github.com/prisma/prisma-client-js/issues/new?body=Hi+Prisma+Team%21+My+Prisma+Client+just+crashed.+This+is+the+report%3A%0A%23%23+Versions%0A%0A%7C+Name+++++%7C+Version++++++++++++%7C%0A%7C----------%7C--------------------%7C%0A%7C+Node+++++%7C+NODE_VERSION+++++++++++%7C+%0A%7C+OS+++++++%7C+darwin+++++++++++++%7C%0A%7C+Prisma+++%7C+1.2.3++++++++++++++%7C%0A%0A%23+Description%0A%60%60%60%0AThis+is+some+crazy+description%0A%60%60%60%0A%0A%23%23+Logs%0A%60%60%60%0A++test-namespace+hello++%2B0ms%0A%60%60%60%0A&title=This+is+a+title&template=bug_report.md
