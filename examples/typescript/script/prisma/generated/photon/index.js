...
class Photon {
    constructor(options = { autoConnect: true }) {
        ...
        this.engine = new runtime_1.Engine({
            cwd: engineConfig.cwd || "/Users/divyendusingh/Documents/prisma/photon-js/examples/typescript/script/prisma/",
            debug: debugEngine,
            datamodel,
