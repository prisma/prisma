...
├── scripts/
│   ├── setup-schema.ts                 # `prisma orm db init`
...
pnpm db:init                     # prisma orm db init → CREATE TABLE …
