/**
 * Refract Basic Example - PostgreSQL with Testcontainers
 *
 * This demo showcases:
 * - Setting up PostgreSQL with Testcontainers
 * - Creating a Refract client with Kysely dialect
 * - Running migrations
 * - CRUD operations
...
// In a real app, these would be generated by `refract generate`
...
interface DatabaseSchema {
  ...
  // Index signature required by RefractClientBase
  [modelName: string]: Record<string, any>
}

async function main() {
  console.log('🚀 Starting Refract Basic Example\n')
  ...
  try {
    ...
    console.log('🔍 Querying user with relations...')
    ...
    await client.$transaction(async (trx) => {
      ...
      console.log('✅ Created user in transaction:', newUser)
      ...
      console.log('✅ Created profile in transaction:', newProfile)
    })
