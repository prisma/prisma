...
- [Aggregate descriptor guide](./reference/aggregate-descriptor-guide.md) — how a target declares aggregate result codecs (`SqlAggregateDescriptor` on `types.aggregateDescriptors`)
