...
| `autoConnect` | `boolean`     | No       | When set to `true`, the `Photon` instance automatically connects to your data source after the constructor was called (see [connection behaviours](#connection-behaviours)). **Default**: `true`. |
