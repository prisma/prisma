...
We have created a dedicated Slack channel for the pioneers that are exploring Prisma 2: [`#prisma2-preview`](https://prisma.slack.com/messages/CKQTGR6T0/). This Slack channel is mainly used for quick and informal conversation and personal exchange. If you have product feedback, questions or run into bugs, please be sure to persist these on GitHub (more info in the sections below).
