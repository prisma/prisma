...
The Prisma Framework is currently running in _Preview_ and has a number of [limitations](./limitations.md). It is not yet considered production-ready! There will a _General Availability_ release later this year where we issue a stable and production-ready version.
...
Our primary goal with the Prisma Framework is to **minimize breaking changes in the future**. 
...
While the Prisma Framework is running in Preview, you can still help us steer the high-level direction as well as figure out specifics of how Prisma should work! After we issue a stable release of the Prisma Framework later this year, there will be a lot less leeway to incorporate major changes into the Prisma Framework. **Now is the right time to provide feedback!** 
...
We have created a dedicated Slack channel for the pioneers that are exploring the Prisma Framework: [**`#prisma2-preview`**](https://prisma.slack.com/messages/CKQTGR6T0/). 
...
As mentioned above, while the Prisma Framework is running in Preview, there is still time to share _your opinion_ of how the Prisma Framework should work. Please make sure to persists any kind of product feedback, feature requests or wild wishes as a GitHub issue in the [`prisma2`](https://github.com/prisma/prisma2) repository!

### Reporting issues and asking questions on GitHub

Whenever you're running into an issue with the Prisma Framework, it's likely that it's not your fault, but ours! 
