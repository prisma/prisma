...
export function TabApp() {
  ...
  return (
    <Box marginTop={1} flexDirection="column">
      <Link href="asd" label="TabApp 2" tabIndex={0} />
      ...
      <BorderBox title="Some Title" flexDirection="column" marginTop={1}>
        ...
        <TextInput label="some lable" value={value1} tabIndex={2} onChange={setValue1} />
        <TextInput label="lubel" value={value2} tabIndex={3} onChange={setValue2} />
        <Checkbox checked={value3} onChange={setValue3} tabIndex={4} label="This is a checkbox" />
      </BorderBox>
      <Box marginTop={1} flexDirection="column">
