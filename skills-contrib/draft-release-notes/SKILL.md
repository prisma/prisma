...
- User-facing migrations: `https://github.com/prisma/orm/blob/v$NEXT/skills/prisma-orm-core-concepts/upgrading/app/upgrades/<transition-label>/`
- Extension-author migrations: `https://github.com/prisma/orm/blob/v$NEXT/skills/prisma-orm-core-concepts/upgrading/extension/upgrades/<transition-label>/`
...
```md
- [@<handle>](https://github.com/<handle>) made their first contribution in [#<pr>](https://github.com/prisma/orm/pull/<pr>)
```
...
- [@somebody](https://github.com/somebody) made their first contribution in [#1238](https://github.com/prisma/orm/pull/1238)
````
